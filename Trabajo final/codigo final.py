...
#se intento realizar la implementacion de taylor pero se tuvo dificultades por lo cual se uso la llibreria scipy que tenia una implementacion de est tipo
def derive(f,nd):
    t=f
